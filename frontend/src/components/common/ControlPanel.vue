    ...
    <div class="bg-grey-dark h-full p-3 rounded-b flex flex-col border border-grey-darkest">
      <div class="border-b border-grey-darkest mb-2 pb-2">
        ...
        <p class="flex items-center justify-between">
          Axis Lines
          <input type="checkbox" name="axis-lines" id="axis-lines" v-model="axisLinesVisible" @click="toggleAxisLines" />
        </p>
      </div>
      ...
      <div class="flex justify-around">
        <a href="https://threejs.org/examples/?q=controls#misc_controls_trackball" target="_blank" class="text-grey-light no-underline hover:text-grey-lighter">Original &#8599; </a>
        <a href="https://github.com/SRLabs/Vue-Three-Demo" target="_blank" class="text-grey-light no-underline hover:text-grey-lighter">Github &#8599; </a>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...mapMutations(['SET_CAMERA_POSITION', 'RESET_CAMERA_ROTATION', 'HIDE_AXIS_LINES', 'SHOW_AXIS_LINES', 'HIDE_PYRAMIDS', 'SHOW_PYRAMIDS']),
    resetCameraPosition() {
